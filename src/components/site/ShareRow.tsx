...
export function ShareRow({ title, url, excerpt }: ShareRowProps) {
  ...
  return (
    <div className="gp-share-row">
      {/* WhatsApp */}
      <a
        className="gp-share-btn gp-share-btn--whatsapp"
      ...
      {/* Facebook */}
      <a
        className="gp-share-btn gp-share-btn--facebook"
      ...
      {/* X (Twitter) */}
      <a
        className="gp-share-btn gp-share-btn--twitter"
      ...
      {/* Copy Link */}
      <button
        className={`gp-share-btn gp-share-btn--copy${copied ? " gp-share-btn--copied" : ""}`}
        onClick={handleCopy}
